...
// Consultar las ubicaciones de los pacientes para el rango de fecha y hora seleccionadas
$sql = "SELECT latitud, longitud FROM ntr_hist";
...
if ($result->num_rows > 0) {
    // Iterar sobre los resultados y crear características GeoJSON para cada ubicación de paciente
